  ...
  if (!isInQueue(message.user, getState())) {
    bot.api.users.info({user: message.user},function(err,response) {
      ...
      bot.startPrivateConversation(message, function(err,convo) {
        ...
        convo.say(`It's group project week! Be advised, your questions need to have more structure than usual, and the responses you receive will be more *advisorial* than actual implementational. 
